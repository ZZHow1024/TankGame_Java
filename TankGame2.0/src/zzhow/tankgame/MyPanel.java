...
public class MyPanel extends JPanel implements KeyListener {
...

    {
        //加载图片
        try {
            image = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/logo/logo.png"));
        } catch (Exception e) {
            System.out.println("未找到 logo.png");
        }
        try {
            image64 = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/logo/logo64.png"));
        } catch (Exception e) {
